    ...
    return (
        <section className="lesson-div container-fluid mx-2">
            ...
            <Row>
                <Col md={8}>
                    <div>
                        <video src={DefultVideo} controls className="w-100 video_player"></video>
                    </div>
                    <div>
                        ...
                        <p>
                            ...
                            veritatis fuga nisi quo a facere fugit perferendis, alias, voluptatem
                            voluptates sapiente! Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Quisquam laborum dicta incidunt temporibus quia enim debitis
                            architecto omnis veritatis fuga nisi quo a facere fugit perferendis,
